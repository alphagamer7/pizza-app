...
class HistoryOrder : NSObject, NSCoding {
    ...
    func updateToppingText() {
            // Convert from array list of toppings to a string with csv toppings
            // Ex: ["Beef", "Ham", "Tomato"] => "Beef, Ham, and Tomato"
